...
#picking unique per disease
#AD_Jansen2019
#PU1
AD_vs_All_pu1<-rbind(PD_Nalls2019proxy_Microglia_interactome, MS_Andlauer2016_Microglia_interactome, ALS_Rheenen2021_Microglia_interactome, SCZ_Trubetskoy2022_Microglia_interactome)
AD_vs_All_pu1<-data.frame(gene_name=AD_vs_All_pu1$gene_name, gene_ensg=AD_vs_All_pu1$gene_ensg)
all_genes<-unique(AD_vs_All_pu1)
save(all_genes, file= paste0(outdir, "Microglia_interactome_AD_Jansen2019_ALL_OTHER_fdr005_output_genes_v4.rda")) #Change name depending on FDR

#OLIG2
AD_vs_All_olig2<-rbind(PD_Nalls2019proxy_Oligo_interactome, MS_Andlauer2016_Oligo_interactome, ALS_Rheenen2021_Oligo_interactome, SCZ_Trubetskoy2022_Oligo_interactome)
AD_vs_All_olig2<-data.frame(gene_name=AD_vs_All_olig2$gene_name, gene_ensg=AD_vs_All_olig2$gene_ensg)
all_genes<-unique(AD_vs_All_olig2)
save(all_genes, file= paste0(outdir, "Oligo_interactome_AD_Jansen2019_ALL_OTHER_fdr005_output_genes_v4.rda")) #Change name depending on FDR

#NEUN
AD_vs_All_neun<-rbind(PD_Nalls2019proxy_Neuronal_interactome, MS_Andlauer2016_Neuronal_interactome, ALS_Rheenen2021_Neuronal_interactome, SCZ_Trubetskoy2022_Neuronal_interactome)
AD_vs_All_neun<-data.frame(gene_name=AD_vs_All_neun$gene_name, gene_ensg=AD_vs_All_neun$gene_ensg)
all_genes<-unique(AD_vs_All_neun)
save(all_genes, file= paste0(outdir, "Neuronal_interactome_AD_Jansen2019_ALL_OTHER_fdr005_output_genes_v4.rda")) #Change name depending on FDR
...
AD_vs_All_pu1<-data.frame(gene_name=AD_vs_All_pu1$gene_name, gene_ensg=AD_vs_All_pu1$gene_ensg)
all_genes<-unique(AD_vs_All_pu1)
save(all_genes, file= paste0(outdir, "Microglia_interactome_AD_Kunkle2019_ALL_OTHER_fdr005_output_genes_v4.rda")) #Change name depending on FDR

#OLIG2
AD_vs_All_olig2<-rbind(PD_Nalls2019proxy_Oligo_interactome, MS_Andlauer2016_Oligo_interactome, ALS_Rheenen2021_Oligo_interactome, SCZ_Trubetskoy2022_Oligo_interactome)
AD_vs_All_olig2<-data.frame(gene_name=AD_vs_All_olig2$gene_name, gene_ensg=AD_vs_All_olig2$gene_ensg)
all_genes<-unique(AD_vs_All_olig2)
save(all_genes, file= paste0(outdir, "Oligo_interactome_AD_Kunkle2019_ALL_OTHER_fdr005_output_genes_v4.rda")) #Change name depending on FDR

#NEUN
AD_vs_All_neun<-rbind(PD_Nalls2019proxy_Neuronal_interactome, MS_Andlauer2016_Neuronal_interactome, ALS_Rheenen2021_Neuronal_interactome, SCZ_Trubetskoy2022_Neuronal_interactome)
AD_vs_All_neun<-data.frame(gene_name=AD_vs_All_neun$gene_name, gene_ensg=AD_vs_All_neun$gene_ensg)
all_genes<-unique(AD_vs_All_neun)
save(all_genes, file= paste0(outdir, "Neuronal_interactome_AD_Kunkle2019_ALL_OTHER_fdr005_output_genes_v4.rda")) #Change name depending on FDR

#PD_Nalls2019proxy
#PU1
PD_vs_All_pu1<-rbind(AD_Jansen2019_Microglia_interactome, AD_Kunkle2019_Microglia_interactome, MS_Andlauer2016_Microglia_interactome, ALS_Rheenen2021_Microglia_interactome, SCZ_Trubetskoy2022_Microglia_interactome)
PD_vs_All_pu1<-data.frame(gene_name=PD_vs_All_pu1$gene_name, gene_ensg=PD_vs_All_pu1$gene_ensg)
all_genes<-unique(PD_vs_All_pu1)
save(all_genes, file= paste0(outdir, "Microglia_interactome_PD_Nalls2019proxy_ALL_OTHER_fdr005_output_genes_v4.rda")) #Change name depending on FDR

#OLIG2
PD_vs_All_olig2<-rbind(AD_Jansen2019_Oligo_interactome, AD_Kunkle2019_Oligo_interactome, MS_Andlauer2016_Oligo_interactome, ALS_Rheenen2021_Oligo_interactome, SCZ_Trubetskoy2022_Oligo_interactome)
PD_vs_All_olig2<-data.frame(gene_name=PD_vs_All_olig2$gene_name, gene_ensg=PD_vs_All_olig2$gene_ensg)
all_genes<-unique(PD_vs_All_olig2)
save(all_genes, file= paste0(outdir, "Oligo_interactome_PD_Nalls2019proxy_ALL_OTHER_fdr005_output_genes_v4.rda")) #Change name depending on FDR

#NEUN
PD_vs_All_neun<-rbind(AD_Jansen2019_Neuronal_interactome, AD_Kunkle2019_Neuronal_interactome, MS_Andlauer2016_Neuronal_interactome, ALS_Rheenen2021_Neuronal_interactome, SCZ_Trubetskoy2022_Neuronal_interactome)
PD_vs_All_neun<-data.frame(gene_name=PD_vs_All_neun$gene_name, gene_ensg=PD_vs_All_neun$gene_ensg)
all_genes<-unique(PD_vs_All_neun)
save(all_genes, file= paste0(outdir, "Neuronal_interactome_PD_Nalls2019proxy_ALL_OTHER_fdr005_output_genes_v4.rda"))

#MS_Andlauer2016
#PU1
MS_vs_All_pu1<-rbind(AD_Jansen2019_Microglia_interactome, AD_Kunkle2019_Microglia_interactome, PD_Nalls2019proxy_Microglia_interactome, ALS_Rheenen2021_Microglia_interactome, SCZ_Trubetskoy2022_Microglia_interactome)
MS_vs_All_pu1<-data.frame(gene_name=MS_vs_All_pu1$gene_name, gene_ensg=MS_vs_All_pu1$gene_ensg)
all_genes<-unique(MS_vs_All_pu1)
save(all_genes, file= paste0(outdir, "Microglia_interactome_MS_Andlauer2016_ALL_OTHER_fdr005_output_genes_v4.rda")) #Change name depending on FDR

#OLIG2
MS_vs_All_olig2<-rbind(AD_Jansen2019_Oligo_interactome, AD_Kunkle2019_Oligo_interactome, PD_Nalls2019proxy_Oligo_interactome, ALS_Rheenen2021_Oligo_interactome, SCZ_Trubetskoy2022_Oligo_interactome)
MS_vs_All_olig2<-data.frame(gene_name=MS_vs_All_olig2$gene_name, gene_ensg=MS_vs_All_olig2$gene_ensg)
all_genes<-unique(MS_vs_All_olig2)
save(all_genes, file= paste0(outdir, "Oligo_interactome_MS_Andlauer2016_ALL_OTHER_fdr005_output_genes_v4.rda")) #Change name depending on FDR

#NEUN
MS_vs_All_neun<-rbind(AD_Jansen2019_Neuronal_interactome, AD_Kunkle2019_Neuronal_interactome, PD_Nalls2019proxy_Neuronal_interactome, ALS_Rheenen2021_Neuronal_interactome, SCZ_Trubetskoy2022_Neuronal_interactome)
MS_vs_All_neun<-data.frame(gene_name=MS_vs_All_neun$gene_name, gene_ensg=MS_vs_All_neun$gene_ensg)
all_genes<-unique(MS_vs_All_neun)
save(all_genes, file= paste0(outdir, "Neuronal_interactome_MS_Andlauer2016_ALL_OTHER_fdr005_output_genes_v4.rda"))

#ALS_Rheenen2021
#PU1
ALS_vs_All_pu1<-rbind(AD_Jansen2019_Microglia_interactome, AD_Kunkle2019_Microglia_interactome, PD_Nalls2019proxy_Microglia_interactome, MS_Andlauer2016_Microglia_interactome, SCZ_Trubetskoy2022_Microglia_interactome)
ALS_vs_All_pu1<-data.frame(gene_name=ALS_vs_All_pu1$gene_name, gene_ensg=ALS_vs_All_pu1$gene_ensg)
all_genes<-unique(ALS_vs_All_pu1)
save(all_genes, file= paste0(outdir, "Microglia_interactome_ALS_Rheenen2021_ALL_OTHER_fdr005_output_genes_v4.rda")) #Change name depending on FDR

#OLIG2
ALS_vs_All_olig2<-rbind(AD_Jansen2019_Oligo_interactome, AD_Kunkle2019_Oligo_interactome, PD_Nalls2019proxy_Oligo_interactome, MS_Andlauer2016_Oligo_interactome, SCZ_Trubetskoy2022_Oligo_interactome)
ALS_vs_All_olig2<-data.frame(gene_name=ALS_vs_All_olig2$gene_name, gene_ensg=ALS_vs_All_olig2$gene_ensg)
all_genes<-unique(ALS_vs_All_olig2)
save(all_genes, file= paste0(outdir, "Oligo_interactome_ALS_Rheenen2021_ALL_OTHER_fdr005_output_genes_v4.rda")) #Change name depending on FDR

#NEUN
ALS_vs_All_neun<-rbind(AD_Jansen2019_Neuronal_interactome, AD_Kunkle2019_Neuronal_interactome, PD_Nalls2019proxy_Neuronal_interactome, MS_Andlauer2016_Neuronal_interactome, SCZ_Trubetskoy2022_Neuronal_interactome)
ALS_vs_All_neun<-data.frame(gene_name=ALS_vs_All_neun$gene_name, gene_ensg=ALS_vs_All_neun$gene_ensg)
all_genes<-unique(ALS_vs_All_neun)
save(all_genes, file= paste0(outdir, "Neuronal_interactome_ALS_Rheenen2021_ALL_OTHER_fdr005_output_genes_v4.rda"))

#SCZ_Trubetsokoy2022
#PU1
SCZ_vs_All_pu1<-rbind(AD_Jansen2019_Microglia_interactome, AD_Kunkle2019_Microglia_interactome, PD_Nalls2019proxy_Microglia_interactome, MS_Andlauer2016_Microglia_interactome, ALS_Rheenen2021_Microglia_interactome)
SCZ_vs_All_pu1<-data.frame(gene_name=SCZ_vs_All_pu1$gene_name, gene_ensg=SCZ_vs_All_pu1$gene_ensg)
all_genes<-unique(SCZ_vs_All_pu1)
save(all_genes, file= paste0(outdir, "Microglia_interactome_SCZ_Trubetskoy2022_ALL_OTHER_fdr005_output_genes_v4.rda")) #Change name depending on FDR

#OLIG2
SCZ_vs_All_olig2<-rbind(AD_Jansen2019_Oligo_interactome, AD_Kunkle2019_Oligo_interactome, PD_Nalls2019proxy_Oligo_interactome, MS_Andlauer2016_Oligo_interactome, ALS_Rheenen2021_Oligo_interactome)
SCZ_vs_All_olig2<-data.frame(gene_name=SCZ_vs_All_olig2$gene_name, gene_ensg=SCZ_vs_All_olig2$gene_ensg)
all_genes<-unique(SCZ_vs_All_olig2)
save(all_genes, file= paste0(outdir, "Oligo_interactome_SCZ_Trubetskoy2022_ALL_OTHER_fdr005_output_genes_v4.rda")) #Change name depending on FDR

#NEUN
SCZ_vs_All_neun<-rbind(AD_Jansen2019_Neuronal_interactome, AD_Kunkle2019_Neuronal_interactome, PD_Nalls2019proxy_Neuronal_interactome, MS_Andlauer2016_Neuronal_interactome, ALS_Rheenen2021_Neuronal_interactome)
SCZ_vs_All_neun<-data.frame(gene_name=SCZ_vs_All_neun$gene_name, gene_ensg=SCZ_vs_All_neun$gene_ensg)
all_genes<-unique(SCZ_vs_All_neun)
save(all_genes, file= paste0(outdir, "Neuronal_interactome_SCZ_Trubetskoy2022_ALL_OTHER_fdr005_output_genes_v4.rda"))
```
...
for(t in 1:length(type)) {
for(c in 1:length(cell)) {
load(file= paste0(outdir, cell[c], "_", type[t], "_ALL_OTHER_fdr005_output_genes_v4.rda")) #all_genes

load(file= paste0(outdir, cell[c], "_",  type[t], "_fdr005_output_genes_v4.rda")) #diseasemat_names

vsall<-data.frame(gene_ensg=setdiff(x = diseasemat_names$gene_ensg, y = all_genes$gene_ensg))

vsall_unique<-merge(x = diseasemat_names, y = vsall, by = "gene_ensg")
save(vsall_unique, file= paste0(outdir, cell[c], "_",  type[t], "_fdr005_output_unique_genes_v4.rda")) #vsall_unique
...
##Combining z sum stats for all plac interactions sampled down 
```{r}
#Merging all the files into one dataframe 

file_list <- list.files(path = paste("/Volumes/aa19618/home/HMAGMA_Protocol/output_annotation_v4/z_sum_v4/"), full.names = TRUE)
...
write.table(x = dataset, file = "/Volumes/aa19618/home/HMAGMA_Protocol/results/tables/z_sum_v4.txt",row.names = F, col.names = T, quote = F, sep = "\t")
```

## HMAGMA output analysis for intr inter regions 
```{r - HMAGMA output analysis }
...
## HMAGMA output analysis for all regions - DONT HAVE UP TO DATE RESULTS
```{r - HMAGMA output analysis }
...
#Directories to save the files 
dir<-"/Volumes/aa19618/home/HMAGMA_Protocol/HMAGMA_output_v2/original/full"
outdir<-"/Volumes/aa19618/home/HMAGMA_Protocol/output_annotation_v3/"

#WITH ASTROCYTES
#genedir
dir.create(path = "/Volumes/aa19618/home/HMAGMA_Protocol/output_annotation_v3/gene_count_all_v3/")
genedir<-"/Volumes/aa19618/home/HMAGMA_Protocol/output_annotation_v3/gene_count_all_v3/"
#z stat directory 
dir.create(path = "/Volumes/aa19618/home/HMAGMA_Protocol/output_annotation_v3/z_mean_all_v3/")
zdir<-"/Volumes/aa19618/home/HMAGMA_Protocol/output_annotation_v3/z_mean_all_v3/"
#z sum stat diretory 
dir.create(path = "/Volumes/aa19618/home/HMAGMA_Protocol/output_annotation_v3/z_sum_all_v3/")
zdir_sum<-"/Volumes/aa19618/home/HMAGMA_Protocol/output_annotation_v3/z_sum_all_v3/"
...
for(c in 1:length(cell)) {
  ...
  #Loading HMAGMA output for each cell type and disease 
  diseasemat<-read.table(paste0(dir, cell[c], "_full_", type[t], "_gc41.genes.out"), header = T)
  ...
  #Counting the number of genes generated by HMAGMA filtered by FDR p<0.05
  gene_count<-data.frame(nrow(diseasemat_names))
  rownames(gene_count) <- paste0(type[t], "_all_", cell[c], "_count")
  gene_count <- data.frame(names = row.names(gene_count), gene_count) 
  gene_count<- gene_count %>% data.frame(do.call("rbind", strsplit(as.character(gene_count$names), "_", fixed = TRUE)))
  write.table(x = gene_count, file = paste0(genedir, type[t], "_all_", cell[c],"_count.txt"), row.names = F, col.names = F, quote = F, sep = "\t")
  
  #z mean per cell type per disease
  z_mean<-data.frame(sum(diseasemat_names$gene_zstat)/gene_count$nrow.diseasemat_names.) #•
  rownames(z_mean)<-paste0(type[t], "_all_", cell[c], "_z_mean") #•
  z_mean <- data.frame(names = row.names(z_mean), z_mean) 
  z_mean<- z_mean %>% data.frame(do.call("rbind", strsplit(as.character(z_mean$names), "_", fixed = TRUE)))
  write.table(x = z_mean, file = paste0(zdir, type[t], "_all_", cell[c], "_z_mean.txt"), 
              row.names = F, col.names = F, quote = F, sep = "\t")
  
  #z sum per cell type per disease 
  z_sum<-data.frame(sum(diseasemat_names$gene_zstat))
  rownames(z_sum)<-paste0(type[t], "_all_", cell[c], "_z_sum") #•
  z_sum <- data.frame(names = row.names(z_sum), z_sum) 
  z_sum<- z_sum %>% data.frame(do.call("rbind", strsplit(as.character(z_sum$names), "_", fixed = TRUE)))
  write.table(x = z_sum, file = paste0(zdir_sum, type[t], "_all_", cell[c], "_z_sum.txt"), 
              row.names = F, col.names = F, quote = F, sep = "\t")
  
  #Assigning a unique name to each file for each cell type for each disease
  #assign(paste0(type[t], "_", cell[c],"_count"), gene_count) 
  assign(paste0(type[t], "_all_", cell[c]), diseasemat_names)
  
  save(diseasemat_names, file= paste0(outdir, cell[c], "_all_",  type[t], "_fdr005_output_genes_v3.rda"))
}
  }
  ...
  colnames(diseasemat_rsids)<-c(c("gene_ensg", "gene_name", "gene_chr", "gene_start", "gene_end",
                                   "gene_strand", "nsnps", "gene_zstat", "gene_p", "gene_fdr", "gene_biotype", "snp_rsid", "snp_chr", "snp_position"))
  save(diseasemat_rsids, file= paste0(outdir, cell[c], "_full_", type[t], "_fdr005_output_snp_v3.rda")) #Change name depending on FDR
}
#}
}
